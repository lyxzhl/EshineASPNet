...
(function (root, factory) {
    ...
    */
    ...
    BootstrapDialog.confirm = function (message, title, callback) {
        return new BootstrapDialog({
            title: title,
            message: message,
            closable: false,
    ...
    BootstrapDialog.confirm = function (message, title,oktext,canceltext, callback) {
        return new BootstrapDialog({
            title: title,
            message: message,
            closable: false,
    ...
    * @returns the created dialog instance
    */
    BootstrapDialog.warning = function (message, torf, callback) {
        return new BootstrapDialog({
            type: BootstrapDialog.TYPE_WARNING,
            message: message,            
            closable: torf
