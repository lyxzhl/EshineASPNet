...
public partial class Overallhealthassessment : PublicClass
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            DataTable dt = MediPlus.login.HealthassessmentAPI(customerID, CType, customerCode, customerGender, customerDOB, QTShortName, ARDetail, Marriage);
            if (dt != null)
            {
