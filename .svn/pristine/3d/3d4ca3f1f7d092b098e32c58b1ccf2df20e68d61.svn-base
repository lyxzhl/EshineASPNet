<%@ Page Language="C#" AutoEventWireup="true" CodeFile="roleAdd.aspx.cs" Theme="Default" Inherits="Admin_roleAdmin_roleAdd" %>
                ...
                <td align="left" colspan="5" style="height: 40px">
                    <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                        <tr>
                            ...
                            <td colspan="2">
                                <input id="Button2" class="button" onclick="location='roleInfo.aspx'" type="button" value="返　回" /></td>
                            <td colspan="1">
