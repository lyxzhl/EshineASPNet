<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CopyrightPolicy.aspx.cs" Inherits="CopyrightPolicy" %>
...
<div class='tencol'>
<div class='tile'>
<h1 style="font-size:26px; color:#606060"><asp:Localize ID="Localize2" runat="server" Text='<%$ Resources:GResource,copyrightpolicy %>'></asp:Localize></h1>
<%=maincontent%>
