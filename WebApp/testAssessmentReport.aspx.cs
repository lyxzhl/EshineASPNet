...
public partial class testAssessmentReport : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string s = PublicClass.postrequest(System.Configuration.ConfigurationManager.AppSettings["appurl"] + "AssessmentReport.aspx", PostVars);
